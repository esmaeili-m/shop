                        ...
                        <form wire:submit="create" class="form-horizontal">
                            ...
                            <div class="row clearfix">
                                ...
                                <div wire:ignore class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                 <textarea  placeholder="توضیحات دسته را وارد کنید"> {{$category->description}}</textarea>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                ...
                                @if ($image)
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 ">
                                            <button type="button" wire:click="remove_image" class="btn btn-info mb-3 text-center">حذف تصویر فعلی</button>
                                            <img class="border-radius-per-15" width="200px" height="200px" src="{{ asset($image) }}">
                                    </div>
                                @endif
                                @if ($new_image)
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 ">
                                            <img class="border-radius-per-15" width="200px" height="200px" src="{{ $new_image->temporaryUrl() }}">
                                    </div>
                                @endif
                            </div>
