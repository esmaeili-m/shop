<div>
                    ...
                    <div class="card">
                        <div class="header">
                            <form wire:submit="save">
                                ...
                                </div><div class="mt-3 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label > مقدار</label>
                                        <div class="form-line">
                                            <input wire:model.lazy="value" type="text"  class="form-control" placeholder="مقدار را وارد کنید">
                                        </div>
                                        @error('value')
                                        <div class="mt-1 ml-1 alert alert-danger border-radius-per-6">
                                            <p>{{$message}}</p>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form wire:submit="update">
                                            ...
                                            <label for="email_address1">مقدار</label>
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input wire:model.lazy="new_value" type="text" id="new_value" class="form-control"
                                                           placeholder="مقدار را وارد کنید">
                                                </div>

                                                <div id="error_div_value" style="display: none"  class="mt-1 ml-1 alert alert-danger border-radius-per-6">
                                                    <p id="error_value"></p>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        @this.on('set-data', (event) => {
            ...
            document.getElementById('new_value').value=event.value;
        });
        @this.on('errortitle', (event) => {
            document.getElementById('error_div_value').style.display='none';
            document.getElementById('error_div_title').style.display='';
            document.getElementById('error_title').innerText=event.title;
        });
        @this.on('errorvalue', (event) => {
            document.getElementById('error_div_title').style.display='none';
            document.getElementById('error_div_value').style.display='';
            document.getElementById('error_value').innerText=event.title;
        });
        @this.on('errorall', (event) => {
            document.getElementById('error_div_title').style.display='';
            document.getElementById('error_div_value').style.display='';
            document.getElementById('error_title').innerText=event.title;
            document.getElementById('error_value').innerText=event.value;
        });
