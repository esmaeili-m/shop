                        ...
                        <form wire:submit="create" class="form-horizontal">
                                ...
                                @foreach($attributesCategory ?? [] as $key => $value)
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <input wire:model.lazy="input.{{$value->id}}" type="text"  class="form-control" placeholder="پاسخ خود را وارد کنید">
                                                </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="row clearfix mr-2">
                                <div wire:ignore class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <textarea  placeholder="توضیحات محصول را وارد کنید"></textarea>
                                </div>
                            </div>
