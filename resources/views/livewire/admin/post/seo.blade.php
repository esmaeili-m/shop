        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <strong>تگ های سئو  </strong> محصول {{$post->title}}</h2>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>لیست تگ های محصول {{$this->post->title}}</h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn tblActnBtn">
                                            <i class="material-icons"><a class="text-dark" href="{{route('post.seo.update',$item->id)}}">mode_edit</a></i>
                                        </button>
