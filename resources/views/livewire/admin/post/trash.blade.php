<div>
    @section('title',' لیست محصولات حذف شده')
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style">
                            ...
                            <li class="breadcrumb-item active">  لیست محصولات حذف شده </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2> لیست محصولات حذف شده</h2>
                            <div class="row">
                                <button class="col-xs-6 col-sm-6 col-md-2 col-lg-2  btn-hover btn-border-radius color-4"><a class="text-white" href="{{route('post.list')}}"> بازگشت</a></button>
    ...
    <script>
        ...
        @this.on('item-undo', (event) => {
            Swal.fire({
                position: "center",
                icon: "success",
                title: 'محصول '+event.title +' با موفقیت بازیابی شد ',
